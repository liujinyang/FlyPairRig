...
% partition text tab1
S.partition_t1_txt = uicontrol(S.camera_panel,'Style','text',...
                'String','Partition : ','Units','normalized', 'Position',[.05 .76 .20 .09],'HorizontalAlignment','left');
            
S.partition_t1_pop = uicontrol(S.camera_panel,'Style','popupmenu',...
                 'String',{'partition No.1','partition No.2'},...
...
% partition text tab2
S.partition_t2_txt = uicontrol(S.data_save_panel,'Style','text',...
                'String','Partition : ','Units','normalized', 'Position',[.05 .8 .20 .05],'HorizontalAlignment','left');
            
S.partition_t2_pop = uicontrol(S.data_save_panel,'Style','popupmenu',...
                 'String',{'partition No.1','partition No.2'},...
                 'BackgroundColor',[1 1 1],'Value',1,'Units','normalized', 'Position',[.26 .85 .32 .01]);
...
S.livestop_radio = uicontrol(S.display_panel,'Style','radiobutton',...
                'String','Live Stop',...
                'Value',1,'Units','normalized','Position',[.03 .12 .3 .5]);
            
S.live_radio = uicontrol(S.display_panel,'Style','radiobutton',...
                'String','Live',...
                'Value',0,'Units','normalized','Position',[.43 .12 .3 .5]);
            
S.memory_radio = uicontrol(S.display_panel,'Style','radiobutton',...
                'String','Memory',...
               'Value',0,'Units','normalized','Position',[.7 .12 .25 .5],'Visible','Off');

S.record_button = uicontrol(S.camera_panel,'Style','pushbutton',...
                'String','Record','Units','normalized', 'Position',[0.22 .12 .3 .08]);
...
S.record_time_txt = uicontrol(S.camera_panel,'Style','text',...
                'String','Record time:','Units','normalized', 'Position',[0 0 .5 .08]);
...
S.frame_slider = uicontrol(S.data_save_panel,'Style','slider','Max',0,'Min',0,'Value',0,...
                 'BackgroundColor',[1 1 1],'Units','normalized', 'Position',[.03 .33 .95 .05]);
